...
function createGrid(options = {}) {
  ...
  const NestedContext = React24.createContext(0);
  ...
  const Grid2 = React24.forwardRef(function Grid3(inProps, ref) {
    ...
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const level = React24.useContext(NestedContext);
    ...
    if (container) {
      result = (0, import_jsx_runtime12.jsx)(NestedContext.Provider, {
        value: level + 1,
        children: result
      });
    }
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-R3DQIYPR.js.map
